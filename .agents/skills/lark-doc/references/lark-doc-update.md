...
> 1. [`../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) — 认证、全局参数和安全规则
...
> **`docs +update` 不能直接编辑已有画板的内容。** 本命令只能**新增**画板块；要修改已有画板，先用 `docs +fetch` 取到 `<whiteboard token="...">`，再切到 [`lark-whiteboard`](../../lark-whiteboard/GUIDE.md) 用 `whiteboard +update` 写入。
...
- [`../../lark-shared/GUIDE.md`](../../lark-shared/GUIDE.md) — 认证和全局参数
