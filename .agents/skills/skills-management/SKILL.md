...
5. 如果工具支持 manifest，优先让它读取仓库根目录的 `AGENTS.md`
6. 只有当工具既不能扫描 `.agents/skills/`，也不能读取 manifest 时，才在仓库内创建本地适配层
...
- 应提交：`.agents/skills/**`、`AGENTS.md`、仓库说明文档
- 不应提交：账号配置、token、本地缓存、本地兼容层目录
